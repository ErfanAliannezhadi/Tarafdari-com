...
urlpatterns = [
    ...
    path('<int:pk>/followers-list/', views.UserFollowersListView.as_view(), name='user_followers_list'),
    path('<int:pk>/followings-list/', views.UserFollowingsListView.as_view(), name='user_followings_list'),
]
